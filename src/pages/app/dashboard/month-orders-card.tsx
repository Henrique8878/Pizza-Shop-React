    ...
    return(
        <Card className="py-6 px-6 space-y-3">
            ...
            <CardContent className="flex flex-col gap-1">
                <span className="text-2xl font-semibold">246</span>
                <CardDescription>
                    <span className="text-muted-foreground"><span className="text-emerald-500 dark:text-emerald-400">+6%</span> em relação ao mês passado</span>
                </CardDescription>
            </CardContent>
        </Card>
    )
